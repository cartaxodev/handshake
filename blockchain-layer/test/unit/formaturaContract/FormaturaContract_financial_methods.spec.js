...
let deployContractNotApprovedFixture;
let contractApprovedFixture;
let contractWithAllPaymentsDoneFixture;
let proposedWithdrawalsFixture;
let authorizedWithdrawalsFixture;


const setFixtures = function (deployContractNotApprovedFixture_, 
                                contractApprovedFixture_, 
                                contractWithAllPaymentsDoneFixture_, 
    ...
    *******************/
    ...
    deployContractNotApprovedFixture = deployContractNotApprovedFixture_;
    contractApprovedFixture = contractApprovedFixture_;
    contractWithAllPaymentsDoneFixture = contractWithAllPaymentsDoneFixture_;
    proposedWithdrawalsFixture = proposedWithdrawalsFixture_;
    authorizedWithdrawalsFixture = authorizedWithdrawalsFixture_;
}


const financialTests = function () {
...
module.exports = {setFixtures, financialTests};